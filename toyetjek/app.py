...
from toyetjek.blueprints.admin import admin
from toyetjek.blueprints.page import page
from toyetjek.blueprints.invitation import invitation
from toyetjek.blueprints.contact import contact
from toyetjek.blueprints.feedback import feedback
from toyetjek.blueprints.user import user
from toyetjek.blueprints.client import client
from toyetjek.blueprints.user.models import User
from toyetjek.extensions import (
    debug_toolbar,
    mail,
    csrf,
    db,
...
CELERY_TASK_LIST = [
    'toyetjek.blueprints.contact.tasks',
    'toyetjek.blueprints.feedback.tasks',
    'toyetjek.blueprints.user.tasks',
]
